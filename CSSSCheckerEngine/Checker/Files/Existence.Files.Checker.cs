...
namespace Checker.Files
{
    ...
    /// existence should use this class as their base, then select
    ...
    abstract class Existence
    {
        ...
        public abstract bool CheckFileExistence(string filePath, bool fileShouldExist, bool isPenaltyIssue);
    }
}
